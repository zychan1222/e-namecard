...
<form id="profileForm" action="{{ route('admin.employee.update', ['id' => $employee->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <dl class="divide-y divide-gray-100">
            ...
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                    ...
                    <input type="text" name="name" value="{{ $employee->name }}" class="border border-gray-300 rounded-md w-1/2 px-4 py-3 hidden">
                </dd>
            </div>
            <!-- CN Name -->
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                    ...
                    <input type="text" name="name_cn" value="{{ $employee->name_cn }}" class="border border-gray-300 rounded-md w-1/2 px-4 py-3 hidden">
                </dd>
            </div>
            <!-- Email -->
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            ...
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                    ...
                    <input type="text" name="phone" value="{{ $employee->phone }}" class="border border-gray-300 rounded-md w-1/2 px-4 py-3 hidden">
                </dd>
            </div>
            <!-- Company Name -->
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                    ...
                    <input type="text" name="company_name" value="{{ $employee->company_name }}" class="border border-gray-300 rounded-md w-1/2 px-4 py-3 hidden">
                </dd>
            </div>
            <!-- Department -->
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                    ...
                    <input type="text" name="department" value="{{ $employee->department }}" class="border border-gray-300 rounded-md w-1/2 px-4 py-3 hidden">
                </dd>
            </div>
            <!-- Designation -->
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                    ...
                    <input type="text" name="designation" value="{{ $employee->designation }}" class="border border-gray-300 rounded-md w-1/2 px-4 py-3 hidden">
                </dd>
            </div>
            <!-- Is Active -->
<!-- Is Active -->
<div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
    ...
    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
        ...
        <button type="submit" class="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:shadow-outline transition ease-in-out duration-150">Save Changes</button>
...
<script>
    // Define a JavaScript variable to track edit mode
    ...
    function toggleEditMode() {
        ...
        // Toggle the value of editMode
        editMode = !editMode;

        // Toggle the display of save buttons based on editMode
