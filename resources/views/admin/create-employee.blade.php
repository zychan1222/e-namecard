...
<div class="mt-6 border-t border-gray-100 lg:pl-20 sm:px-0">
    ...
    <form id="profileForm" action="{{ route('admin.employee.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <dl class="divide-y divide-gray-100">
            ...
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                    <input type="text" name="name" value="{{ old('name') }}" class="border border-gray-300 rounded-md w-1/2 px-4 py-3" required>
                </dd>
            </div>
            <!-- CN Name -->
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                    <input type="text" name="name_cn" value="{{ old('name_cn') }}" class="border border-gray-300 rounded-md w-1/2 px-4 py-3" required>
                </dd>
            </div>
            <!-- Email -->
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                    <input type="email" name="email" value="{{ old('email') }}" class="border border-gray-300 rounded-md w-1/2 px-4 py-3" required>
                </dd>
            </div>
            <!-- Phone -->
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                    <input type="text" name="phone" value="{{ old('phone') }}" class="border border-gray-300 rounded-md w-1/2 px-4 py-3" required>
                </dd>
            </div>
            <!-- Department -->
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                    <input type="text" name="department" value="{{ old('department') }}" class="border border-gray-300 rounded-md w-1/2 px-4 py-3" required>
                </dd>
            </div>
            <!-- Designation -->
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                    <input type="text" name="designation" value="{{ old('designation') }}" class="border border-gray-300 rounded-md w-1/2 px-4 py-3" required>
                </dd>
            </div>
            <!-- Is Active -->
            <div class="px-8 py-6 lg:pl-20 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                    <select name="is_active" class="border border-gray-300 rounded-md px-4 py-3">
        ...
        <div id="saveButtons" class="flex justify-center mt-6">
    <div class="space-x-4">
